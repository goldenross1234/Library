...
const useFetch = (API_URL) => {
  ...
  const fetchData = async () => {
    try {
      ...
      // ${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/uploads/02e2af9df9c9a02234688a77241924f2 CORRECT

      // ${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/uploads\bb367469a423603133b0c570eda20730
